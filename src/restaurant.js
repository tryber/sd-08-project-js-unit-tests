...
const createMenu = (array) => {
  const restaurant = {};
  const fetchMenu = () => array;
  restaurant.fetchMenu = fetchMenu;
  return restaurant;
};
const addConsumption = (restaurant) => {
  console.log(restaurant);
  restaurant.consumption = 'abc';
  console.log(restaurant);
  return restaurant;
};
...
// let objetoRetornadoTeste5 = createMenu({ food: {}, drink: {} });
//     order("coxinha")
// console.log(objetoRetornadoTeste5);
