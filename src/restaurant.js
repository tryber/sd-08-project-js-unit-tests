...
// const restaurant = {}
//
// const createMenu = obj =>  Lógica que edita o objeto `restaurant`
//
...
const createMenu = (obj) => {
  const tempObj = {
    ...
    pay: () => {
      const totalPrice = tempObj.consumption.map((e) => {
      ...
      return +(totalPrice.reduce((a, c) => (a += c)) * 1.1).toFixed(2);
    },
  };
  return tempObj;
};
