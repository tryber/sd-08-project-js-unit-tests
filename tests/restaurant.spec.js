...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(typeof createMenu(Object).fetchMenu(), 'object');
    // ```
    ...
    const objetoRetornadoTeste3 = { food: {}, drink: {} };
    assert.deepStrictEqual(createMenu(objetoRetornadoTeste3).fetchMenu, objetoRetornadoTeste3);
    // ```
    ...
    const parametroTeste5 = 'coxinha';
    objetoRetornadoTeste5.order(parametroTeste5);
    assert.deepStrictEqual(objetoRetornadoTeste5.consumption, [`${parametroTeste5}`]);
    ...
    // ```
    const objetoRetornadoTeste8 = createMenu({ food: { sashimi: 10 }, drink: { agua: 2 } });
    objetoRetornadoTeste8.order("agua");
    objetoRetornadoTeste8.order("agua");
    objetoRetornadoTeste8.order("sopa");
    objetoRetornadoTeste8.order("sashimi");
    const valorTotal = 15.4;
    assert.deepStrictEqual(objetoRetornadoTeste8.pay(), valorTotal)
    // ```
