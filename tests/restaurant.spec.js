...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objetoQualquer = { food: {'coxinha': 3.9, 'sopa': 9.9}, drinks: {'agua': 3.9, 'cerveja': 6.9} };
    let objetoRetornado = createMenu(objetoQualquer);
    const testMenu = objetoRetornado.fetchMenu;
    assert.deepStrictEqual(testMenu, { food: {'coxinha': 3.9, 'sopa': 9.9}, drinks: {'agua': 3.9, 'cerveja': 6.9} });
