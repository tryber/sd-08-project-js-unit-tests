...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const meuRestaurante = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} })
    assert.deepStrictEqual(createMenu(objMenu), {"fetchMenu": {"drink": {"agua": 3.9, "cerveja": 6.9}, "food": {"coxinha": 3.9, "sopa": 9.9}}});
    // ```
    // createMenu(objetoQualquer) // Retorno: { fetchMenu: objetoQualquer }
    // ```
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 2: Verifique que, dado que a função createMenu foi chamada com o objeto: ``, verifique que 'objetoRetornado.fetchMenu' retorna um objeto cujas chaves são somente `food` e `drink`.
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.fetchMenu // Retorno: { food: {}, drink: {}}
    // const objVazio = createMenu({ food: {}, drink: {} }).
    assert.deepStrictEqual(createMenu({ food: {}, drink: {} }), {"fetchMenu": {"drink": {}, "food": {}}});
