...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(objetoRetornado.hasOwnProperty('fetchMenu'), true);
    ...
    const test = createMenu({ str1: {}, str2: {} });
    assert.deepStrictEqual(Object.keys(test.fetchMenu), ['str1', 'str2']);
    // ```
    ...
    assert.deepStrictEqual(test.fetchMenu, { str1: {}, str2: {} });
    // ```
    ...
    assert.deepStrictEqual(test.consumption, []);
    // ```
    ...
    test.order('coxinha');
    assert.strictEqual(test.consumption.includes('coxinha'), true);
    // ```;
