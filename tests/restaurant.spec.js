...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // --------------------------------------------------------------------------------------
    assert.deepStrictEqual(createMenu({ foods: { coxinha: 3.90, sanduiche: 9.90 }, drinks: { agua: 3.90, cerveja: 6.90 } }).fetchMenu(),
      { foods: { coxinha: 3.90, sanduiche: 9.90 }, drinks: { agua: 3.90, cerveja: 6.90 } });
    ...
    const test8 = createMenu({ foods: { coxinha: 3.90, sanduiche: 9.90 }, drinks: { agua: 3.90, cerveja: 6.90 } });
    test8.order("coxinha");
    test8.order("agua");
    test8.order("coxinha");
