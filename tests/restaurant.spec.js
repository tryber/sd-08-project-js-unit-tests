...
describe('#createMenu', () => {
    it('tests the function has the correct behaviour', () => {
        ...
        assert.strictEqual(typeof createMenu('objetoQualquer').fetchMenu, 'function')
        ...
        assert.deepStrictEqual(createMenu({ food: {}, drink: {} }).fetchMenu(), { food: {}, drink: {} })
            ...
            // --------------------------------------------------------------------------------------
        assert.strictEqual(createMenu('objetoQualquer3').fetchMenu(), 'objetoQualquer3');
        ...
        // --------------------------------------------------------------------------------------
        assert.deepStrictEqual(createMenu('objetoRetornadoTeste4').consumption, [])
