...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(objetoRetornadoTeste5.order('coxinha').consumption, ['coxinha']);
    // ```
    ...
    // ```
    const objetoRetornadoTeste8 = createMenu({ food: { sopa: 9.9, sashimi: 9.9 }, drink: { agua: 3.9 }});
    ...
    assert.deepStrictEqual(objetoRetornadoTeste8.pay(), 23.7);
    // ```
