...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), objetoQualquer); // Retorno: { fetchMenu: objetoQualquer }
    // ```
    ...
    assert.deepStrictEqual(keys, ['food', 'drink']); // Retorno: { food: {}, drink: {}}
    // ```
    // Agora faça o TESTE 3 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), objetoQualquer); // Retorno: objetoQualquer
    // ```
    // Agora faça o TESTE 4 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    assert.deepStrictEqual(objetoRetornado.consumption, []); // Retorno: []
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ['coxinha']); // Retorno: ["coxinha"]
    // ```
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.deepStrictEqual(objetoRetornado.pay(), 12.87); // Retorno: somaDosPreçosDosPedidos
    // ```
