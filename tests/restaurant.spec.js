...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const objetoRetornadoTeste1 = createMenu(pedido);
    assert.ok(typeof objetoRetornadoTeste1.fetchMenu === 'function');
    assert.deepStrictEqual(objetoRetornadoTeste1.fetchMenu(), pedido);
    ...
    // ```
    const objetoRetornadoTeste3 = createMenu(pedido);
    assert.deepStrictEqual(objetoRetornadoTeste3.fetchMenu(), pedido);
    ...
    // ```
    const objetoRetornadoTeste4 = createMenu(pedido);
