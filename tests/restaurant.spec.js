...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // --------------------------------------------------------------------------------------
    const test = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 12}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    ...
    test.order('coxinha');
    assert.strictEqual(test.consumption[0], 'coxinha');
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    test.order('sopa');
    test.order('sashimi');
    assert.deepStrictEqual(test.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    // objetoRetornado.order("coxinha");
    ...
    test.order('coxinha');
    assert.deepStrictEqual(test.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    ...
    assert.strictEqual(test.pay(), 36.96);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
