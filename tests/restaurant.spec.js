...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // checa se o retorno da função é um objeto que contêm a chave `fetchMenu` e esta por sua vez tem como valor 
    // uma função que ao ser executada retorna um objeto qualquer. Exemplo de retorno: { fetchMenu: function }.
    // ```
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 2: Verifique que, quando a função createMenu for chamada passando como
    // parâmetro o objeto: `{ food: {}, drink: {} }`, retorne um objeto que ao executar a
    // função associada a propriedade `fetchMenu` deste objeto, o retorno da função de ser um 
    // objeto que tenha somente as chaves `food` e `drink`.
    // ```
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 3: Verifique que o menu passado como parâmetro para a função createMenu é idêntico ao
    // menu retornado pela função `fetchMenu`, dentro do objeto retornado pela função `createMenu`.
    ...
    // ```
    const menuTest4 = createMenu({food: {}, drink: {}});
    menuTest4.order('coxinha');
    assert.deepStrictEqual(menuTest4.consumption, ['coxinha']);
