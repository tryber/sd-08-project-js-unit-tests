...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.ok(objetoRetornadoTeste5.consumption.includes('coxinha'));
    ...
    objetoRetornadoTeste6.consumption // Valor: ["agua", "sopa", "sashimi"]a
    assert.strictEqual(objetoRetornadoTeste6.consumption.length, 3);
    // ```
    ...
    // ```
    const objetoRetornadoTeste8 = createMenu({ food: { 'sashimi': 12.0, 'sopa': 10.0 }, drink: { 'agua': 4.0, 'cerveja': 7.0 } });
    objetoRetornadoTeste8.order("agua");
    objetoRetornadoTeste8.order("agua");
    objetoRetornadoTeste8.order("sopa");
    objetoRetornadoTeste8.order("sashimi");
    assert.strictEqual(objetoRetornadoTeste8.pay(), 33)// Retorno: somaDosPreçosDosPedidos
    // ```
