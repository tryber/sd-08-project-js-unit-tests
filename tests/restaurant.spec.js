...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu({ food: { 'rice': 3, 'beans': 2 }, drink: { 'coke': 5, 'soda': 3 } }).fetchMenu(), { food: { 'rice': 3, 'beans': 2 }, drink: { 'coke': 5, 'soda': 3 } });
