...
const addConsumption = require('../src/restaurant');
...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.notDeepStrictEqual(createMenu(objetoQualquer), restaurant);
    ...
    assert.deepStrictEqual(addConsumption(objetoRetornado4).consumption, []);
    ...
    // ```;
    let objetoRetornadoTeste5 = createMenu(objetoQualquer);
    order("coxinha");
