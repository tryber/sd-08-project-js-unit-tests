...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {    
    ...
    assert.deepStrictEqual(objetoRetornado4.consumption, [ 'agua', 'sopa', 'sashimi' ]);
    ...
    // ```
    const objetoRetornado3 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9, 'sanduiche': 9.90}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    ...
    assert.strictEqual(objetoRetornado3.pay(), 45.54);
