...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.ok(Object.keys(createMenu(obj)).includes('fetchMenu'));
    assert.deepStrictEqual(typeof createMenu(obj).fetchMenu, 'function');
    assert.deepStrictEqual(typeof createMenu(obj).fetchMenu(), 'object');
    ...
    // ```
    assert.deepStrictEqual(createMenu(obj1).fetchMenu(), { food: {}, drink: {} });
    ...
    // ```
    assert.ok(Array.isArray(createMenu(obj).consumption));
    ...
    assert.deepStrictEqual(newMenu.consumption[0], 'coxinha');
    ...
    newMenu.order('sopa');
    newMenu.order('agua');
    assert.deepStrictEqual(newMenu.consumption, ['coxinha', 'sopa', 'agua']);
    ...
    newMenu.order('coxinha');
    assert.deepStrictEqual(newMenu.consumption, ['coxinha', 'sopa', 'agua', 'coxinha']);
    // ```
    ...
    // ```
    assert.strictEqual(newMenu.pay(), 21.6);
