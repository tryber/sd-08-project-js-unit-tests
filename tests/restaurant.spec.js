...
/*
  ...
  desenvolvimento do sistema. Eles guiarão você pelo desenvolvimento.
  ...
  - Uma chave `fetchMenu` retorna o objeto que a função `createMenu` recebe por parâmetro. O menu tem sempre 
  duas chaves, `food` e `drink`, no seguinte formato:
...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // TESTE 1: Verifique que, dado um objeto qualquer passado como um parâmetro para a 
    //função createMenu(), checa se o retorno da função é um objeto no seguinte 
    //formato: { fetchMenu: objetoQualquer }.
    // createMenu(objetoQualquer) // Retorno: { fetchMenu: objetoQualquer }
    assert.deepStrictEqual(createMenu({}).fetchMenu(), {})
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 2: Verifique que, dado que a função createMenu foi chamada com o 
    //objeto: `{ food: {}, drink: {} }`, verifique que 'objetoRetornado.fetchMenu' 
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao 
    //menu recuperado pela função 'objetoRetornado.fetchMenu'
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu,
