...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    objetoRetornadoTeste1.fetchMenu(); // retorno: objetoQualquer
    // ```
    assert.strictEqual(typeof(createMenu), 'function');
    assert.strictEqual(Object.keys(objetoRetornadoTeste1)[0], 'fetchMenu');
    ...
    // ```
    objetoQualquer = {food: 'empanadas', drink: 'água com gás'};
