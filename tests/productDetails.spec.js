...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.notStrictEqual(
      productDetails('Alcool gel', 'Máscara')[0].name,
      productDetails('Alcool gel', 'Máscara')[1].name,
    );
    ...
    assert.strictEqual(first, 'Alcool gel123');
    assert.strictEqual(second, 'Máscara123');
  });
});
