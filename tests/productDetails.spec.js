...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual((Object.values(productDetails('Alcool gel', 'Máscara')[0].details))[0].endsWith('123'), true);
    assert.deepStrictEqual((Object.values(productDetails('Alcool gel', 'Máscara')[1].details))[0].endsWith('123'), true);
  });
});
